          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                <a
                  href="tel:07200210022"
                  className="group flex items-center justify-center gap-2 md:gap-3 flex-1 bg-gradient-to-r from-[#7fb3a0] to-[#5a9179] text-white px-4 py-4 md:px-6 md:py-5 rounded-full hover:shadow-2xl transition-all font-bold text-sm md:text-base"
                >
                  <span className="text-xl md:text-2xl">📞</span>
                ...
                <a
                  href="https://wa.me/917200210022?text=Hi%2C%20I%20would%20like%20to%20book%20an%20appointment%20at%20EDEN%20Dental"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center gap-2 md:gap-3 flex-1 bg-[#25D366] text-white px-4 py-4 md:px-6 md:py-5 rounded-full hover:shadow-2xl transition-all font-bold text-sm md:text-base"
                >
                  <svg
            ...
            <div className="h-[300px] md:h-[600px] rounded-2xl md:rounded-3xl overflow-hidden shadow-xl md:shadow-2xl border-2 md:border-4 border-white relative w-full max-w-full">
              <Image
                src="/Screenshot 2026-06-01 124808.png"
                alt="EDEN Dental Clinic Location"
                fill
                className="object-cover"
                style={{
                  objectPosition: "center 50%",
